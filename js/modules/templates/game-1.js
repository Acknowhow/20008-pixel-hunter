...
import {paintingsPeople} from './loader/imageLoader';
  ...
  <div class="game">
    ...
    <form class="game__content">
      <div class="game__option">
        <img ${[...Object.entries(questions[`question1`].params).map((question) => question)].join(` `).replace(/,/g, ` `)} src="${paintingsPeople[0]}">
